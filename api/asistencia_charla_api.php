...
elseif (isset($_GET["asistencia"])) 
{
    ...
    //  header("location:../vistas/gestion_asistencia_charla_vista.php?msj=1"); 
	 echo "<script> window.location.replace('https://www.desarrollo.informaticaunah.com/automatizacion/vistas/gestion_asistencia_charla_vista.php?msj=1'); </script>";
	...
	else
	{
		...
		//   header("location:../vistas/gestion_asistencia_charla_vista.php?msj=4"); 
		  echo "<script> window.location.replace('https://www.desarrollo.informaticaunah.com/automatizacion/vistas/gestion_asistencia_charla_vista.php?msj=4'); </script>";
 	...
 	if ($asistencia>=1) {
		 ...
		 header("location: https://www.desarrollo.informaticaunah.com/automatizacion/vistas/gestion_asistencia_charla_vista.php?msj=2"); 
		// header("location:../vistas/gestion_asistencia_charla_vista.php?msj=2"); 
			...
			else
			{
				    //  header("location:../vistas/gestion_asistencia_charla_vista.php?msj=3"); 
					 header("Location: https://www.desarrollo.informaticaunah.com/automatizacion/vistas/gestion_asistencia_charla_vista.php?msj=3", TRUE, 301);
