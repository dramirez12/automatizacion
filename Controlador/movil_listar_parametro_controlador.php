...
<table id="tabla" class="table table-bordered table-striped" style="width: 100%; overflow-x:auto;">
   <thead>
      <tr>
         <th>ID</th>
         <th>PARÁMETRO</th>
     ...
     $parametros = array();
      ...
      while ($parametro = $resultado_parametros->fetch_array(MYSQLI_ASSOC)) { 
         ...
         <tr>
            ...
            <td style="text-overflow: auto;"><?php echo $parametro['descripcion']; ?></td>
            <td style="text-overflow: auto;"><?php echo $parametro['valor']; ?></td>
