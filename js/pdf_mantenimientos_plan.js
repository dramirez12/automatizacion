        ...
        dom: 'Bfrtip',
          ...
          mergeCells.attr('count', mergeCells.attr('count') + 1);
      ...
      
              {
                  ...
                  "title": 'Reporte de periodos del plan',  
                  ...
                  "exportOptions": {
                                  ...
                                  page: 'current'
                                   ...
                                   ) +'    HORA: '+ (new Date().getHours()+':'+new Date().getMinutes()+':'+new Date().getSeconds()).toString() + '                  REPORTE DE PERIODOS PLAN DE ESTUDIO ', 
        ...
        dom: 'Bfrtip',
          ...
          mergeCells.attr('count', mergeCells.attr('count') + 1);
      ...
      
              {
                  ...
                  "pageSize": 'legal',
                  "orientation": 'portrait',
                  "title": 'Reporte de nombre tipo plan de estudios',  
                  "text":   'PDF <i class = "fa fa-print"></i>',
                  "titleAttr":'Exportar a PDF',
                  "className":'btn btn-danger',
                  ...
                  "exportOptions": {
                                  ...
                                  page: 'current'
                                   ...
                                   messageTop: '         FECHA: '+  ((new Date().getDate()+'-'+(new Date().getMonth()+1)+'-'+new Date().getFullYear()).toString()
                                   ) +'    HORA: '+ (new Date().getHours()+':'+new Date().getMinutes()+':'+new Date().getSeconds()).toString() + '                REPORTE DE NOMBRE TIPO PLAN DE ESTUDIOS ', 
      ...
      
              {
                  ...
                  "exportOptions": {
                                  ...
                                  page: 'current'
                                   ...
                                   messageTop: '         FECHA: '+  ((new Date().getDate()+'-'+(new Date().getMonth()+1)+'-'+new Date().getFullYear()).toString()
                                   ) +'    HORA: '+ (new Date().getHours()+':'+new Date().getMinutes()+':'+new Date().getSeconds()).toString() + '                                           REPORTE DE AREAS ', 
