...
$("#tabla1").DataTable({
    ...
    dom: 'Bfrtip',
         ...
         /* {
              ...
              "title": 'Reporte de administración de Empleados',
              ...
              row: _createNode(sheet, 'is', {
                  children: {
                      row: _createNode(sheet, 't', {
                          ...
                          text: '  Consultores de Sistemas de Honduras S.A.  Reporte de administración de Empledos '
...
$(document).ready(function() {
  $("#tabla").DataTable({
      ...
      customize: function(doc) {
        ...
        doc.content[2].table.widths = ["35%", "27%", "22%", "22%"];
        doc.styles.tableBodyEven.alignment = 'center';
        doc.styles.tableBodyOdd.alignment = 'center'; 
...
$(document).ready(function() {
  ...
  $(document).ready(function() {
    $("#tabla3").DataTable({
      ...
      document.getElementById("tabla3_filter").style.display = "none";
      $('input.global_filter').on('keyup click', function () {
        filterGlobal1();
      });
      $('input.column_filter').on('keyup click', function () {
  ...
  $(document).ready(function() {
    $("#tabla4").DataTable({
      ...
      document.getElementById("tabla4_filter").style.display = "none";
      $('input.global_filter').on('keyup click', function () {
        filterGlobal1();
      });
      $('input.column_filter').on('keyup click', function () {
   ...
   $(document).ready(function() {
    $("#tabla5").DataTable({
      ...
      document.getElementById("tabla5_filter").style.display = "none";
      $('input.global_filter').on('keyup click', function () {
        filterGlobal1();
      });
      $('input.column_filter').on('keyup click', function () {
...
$(document).ready(function() {
  $("#tabla8").DataTable({
    ...
    document.getElementById("tabla8_filter").style.display = "none";
    $('input.global_filter').on('keyup click', function () {
      filterGlobal1();
    });
    $('input.column_filter').on('keyup click', function () {
      ...
      dom: 'Bfrtip',
        ...
        mergeCells.attr('count', mergeCells.attr('count') + 1);
    ...
    
            {
                ...
                "pageSize": 'legal',
                "orientation": 'portrait',
                "title": 'Reporte de grados académicos',  
                "text":   'PDF <i class = "fa fa-print"></i>',
                "titleAttr":'Exportar a PDF',
                "className":'btn btn-danger',
                ...
                "exportOptions": {
                                ...
                                page: 'current'
                                 ...
                                 messageTop: '    FECHA: '+  ((new Date().getDate()+'-'+(new Date().getMonth()+1)+'-'+new Date().getFullYear()).toString()
                                 ) +'    HORA: '+ (new Date().getHours()+':'+new Date().getMinutes()+':'+new Date().getSeconds()).toString() + '                            REPORTE GRADOS ACADÉMICOS ', 
...
$(document).ready(function() {
  $("#tabla10").DataTable({
    ...
    document.getElementById("tabla10_filter").style.display = "none";
    $('input.global_filter').on('keyup click', function () {
      filterGlobal1();
    });
    $('input.column_filter').on('keyup click', function () {
...
$(document).ready(function() {
  $("#tabla15").DataTable({
    ...
    
            {
                ...
                "exportOptions": {
                                ...
                                page: 'current'
                                 ...
                                 messageTop: '    FECHA: '+  ((new Date().getDate()+'-'+(new Date().getMonth()+1)+'-'+new Date().getFullYear()).toString()
                                 ) +'    HORA: '+ (new Date().getHours()+':'+new Date().getMinutes()+':'+new Date().getSeconds()).toString() + '                                     REPORTE DE CARRERA ', 
      ...
      customize: function(doc) {
        doc.content[2].margin = [ 150, 0, 150, 0 ], //left, top, right, bottom
        doc.content[2].margin = [100, 15, 100, 0]
        doc.content[2].table.widths = ["60%", "45%"];
          doc.styles.tableBodyEven.alignment = 'center';
          doc.styles.tableBodyOdd.alignment = 'center'; 
    ...
    document.getElementById("tabla15_filter").style.display = "none";
    $('input.global_filter').on('keyup click', function () {
      filterGlobal1();
    });
    $('input.column_filter').on('keyup click', function () {
  ...
  function filterGlobal1() {
    ...
    $("#tabla2").DataTable().search($("#global_filter").val()).draw();
    $("#tabla3").DataTable().search($("#global_filter").val()).draw();
    $("#tabla4").DataTable().search($("#global_filter").val()).draw();
    $("#tabla5").DataTable().search($("#global_filter").val()).draw();
    $("#tabla6").DataTable().search($("#global_filter").val()).draw();
    $("#tabla7").DataTable().search($("#global_filter").val()).draw();
    $("#tabla8").DataTable().search($("#global_filter").val()).draw();
    $("#tabla9").DataTable().search($("#global_filter").val()).draw();
    $("#tabla10").DataTable().search($("#global_filter").val()).draw();
    ...
    $("#tabla15").DataTable().search($("#global_filter").val()).draw();
