<?php
    ...
    class ApiRestReadNotification
    {

        public function notificacionLeida($datosJson)
        {
            try {
                ...
                */
                ...
                /* Estructura que se debe recibir al actualizar todos los registros
                    {
                ...
                */
                ...
                if(isset($datosArray['notifUsuario']))
                {
                    ...
                    {
                        $respuesta = $consulta->actualizarNotLeida($datosArray['notifUsuario']);                   
