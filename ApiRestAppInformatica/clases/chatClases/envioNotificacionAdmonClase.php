<?php
    ...
    class ApiRestSendNotificationAdmon
    {

        public function sendNotificationAdmon($datosJson)
        {
            try {
                ...
                $datosArray = json_decode($datosJson, true);
                 ...
                 /* Estructura que se debe recibir
                    {
                        "usuarioRemitente": "Para saber quien envia la notificacion, Titulo de la notificacion y sera el nombre de quien envia la notificacion",
                        "usuarioReceptor": "Para quien va dirigida la notificacion",
                        "mensaje": "mensaje que envia el usuario",
                        "urlRecurso": "url de la imagen de momento enviar 'null' en string"
                    }
                */

                if(isset($datosArray['usuarioRemitente']) && isset($datosArray['usuarioReceptor']) && 
                isset($datosArray['mensaje']) && isset($datosArray['urlRecurso']))
                {
                    ...
                    }else
                    {
                        ...
                        {
                            //Del remitente
                            $respNombre = $consulta->obtenerNombreAdmon(strtoupper($datosArray['usuarioRemitente']));
