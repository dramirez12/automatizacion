<?php
    ...
    require_once "../../clases/registroClases/getTipoPersonaClase.php";

    //Objetos
    $conexion = new Conexion();
    $person = new ApiRestPersonType();
    ...
    }elseif(isset($_SERVER['REQUEST_METHOD']))
    {
        ...
        {    
            $respuestaApi = $person->getPersonType();
            ...
            {  
                ...
                $mensaje = "No se encontraron los tipos de personas";
