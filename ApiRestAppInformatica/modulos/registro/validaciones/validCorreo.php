<?php
    ...
    require_once "../../../clases/registroClases/validacionesClases/validCorreoClase.php";

    //Objetos
    $conexion = new Conexion();
    $valid = new ApiRestValidCorreo();
    ...
    }elseif(isset($_SERVER['REQUEST_METHOD']))
    {
        ...
        {    
            if(isset($_GET['correo']))
            {
                if($_GET['correo'] != null)
                {
                    $respuestaApi = $valid->validCorreo($_GET['correo']);
