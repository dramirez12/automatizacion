<?php
    ...
    require_once "../../clases/chatClases/envioNotificacionClase.php";
            ...
            try {
                ...
                switch ($respuestaApi) 
                {
                    ...
                    case "nombre":
                        ...
                        $mensaje = "Este usuario no tiene un nombre y apellido asignado";
                        echo json_encode($httpResponseCode->notFound($mensaje));
                        break;
                    case "user":
                        http_response_code(404);
                        $mensaje = "Este usuario no tiene un token asignado";
                        echo json_encode($httpResponseCode->notFound($mensaje));
                        break;
                    case "var":
