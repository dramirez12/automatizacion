<?php
    ...
    require_once "../../clases/chatClases/insertMensajeClase.php";

    $conexion = new Conexion();  
    $httpResponseCode = new httpResponseCode();
    $insertMessage = new ApiRestInsertMessage();
    ...
    }elseif(isset($_SERVER['REQUEST_METHOD']))
    {
        if($_SERVER['REQUEST_METHOD'] == 'POST')
        {
            try {
                    ...
                    $respuestaApi = $insertMessage->insertMessage($datosJson);
                    
                    if(isset($respuestaApi['idMensaje']))
                    {
