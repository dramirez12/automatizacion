<?php
    ...
    require_once "../../clases/chatClases/getMensajesClase.php";

    //Objetos
    $conexion = new Conexion();
    $messages = new ApiGetMessage();
    ...
    }elseif(isset($_SERVER['REQUEST_METHOD']))
    {
        ...
        {    
            if(isset($_GET['token']) && isset($_GET['session']) && isset($_GET['idMensaje']))
            {
                $respuestaApi = $messages->getMessage($_GET['token'], $_GET['session'], $_GET['idMensaje']);
