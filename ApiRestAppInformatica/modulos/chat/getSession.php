<?php
    ...
    require_once "../../clases/chatClases/getSessionClase.php";

    //Objetos
    $conexion = new Conexion();
    $session = new ApiGetSession();
    ...
    }elseif(isset($_SERVER['REQUEST_METHOD']))
    {
        ...
        {    
            ...
            {
                $respuestaApi = $session->getSession($_GET['token'], $_GET['session']);
                ...
                {  
                    ...
                    $mensaje = "No tiene chats disponibles";
