<?php
    ...
    require_once "../../clases/loginClases/resetPasswordPreguntasClase.php";

    $conexion = new Conexion();   
    $consulta = new Consultas(); 
    $httpResponseCode = new httpResponseCode();
    $reset = new ApiRestResetPasswordQuestions();
    ...
    }elseif(isset($_SERVER['REQUEST_METHOD']))
    {
        if($_SERVER['REQUEST_METHOD'] == 'PUT')
        {
            try {
                    ...
                    $respuestaApi = $reset->resetPasswordQuestion($datosJson);
