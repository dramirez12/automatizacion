<?php
    ...
    require_once "../../clases/notificacionesClases/confirmarNotificacionClase.php";

    $conexion = new Conexion();   
    $consulta = new Consultas(); 
    $httpResponseCode = new httpResponseCode();
    $confirmar = new ApiRestConfirmNotification();
    ...
    }elseif(isset($_SERVER['REQUEST_METHOD']))
    {
        if($_SERVER['REQUEST_METHOD'] == 'PUT')
        {
            try {
                    ...
                    $respuestaApi = $confirmar->confirmNotificacion($datosJson);
