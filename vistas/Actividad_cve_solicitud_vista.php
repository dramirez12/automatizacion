              ...
              <div id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="box-header with-border">
                    <section>
                      <h5><b><i>
                            <p>Fecha de Solicitud: <?php echo $hoy; ?>
                          </i></b></p>
                      </h5>
                    </section>
                  </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="FECHA" name="fch_inicial_actividad" id="fch_inicial_actividad" required="" required min=<?php $hoy = date("Y-m-d");
                                                                                                                                                                          echo $hoy; ?> />
                          </div>
                        </div>
                        <!-- Fecha Final-->
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="fch_final_actividad" id="fch_final_actividad" required="" required min=<?php $hoy = date("Y-m-d");
                                                                                                                                                  echo $hoy; ?>>
                          </div>
                        </div>
