            ...
            <div class="col-sm-3" align="right">
              ...
              <div class="row">
                <div class="col-sm-3 text-right">
                  <h1 align="right"><button class="btn btn-success" name="btnagregar" id="btnagregar" <?php echo $_SESSION['btnagregar']; ?> onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar Estudiante</button></h1>
