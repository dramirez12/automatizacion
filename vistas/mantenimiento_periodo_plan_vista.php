    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" id="btn_modificar_periodo_plan" name="btn_modificar_periodo_plan" <?php echo $_SESSION['btn_modificar_periodo_plan']; ?>>Guardar Cambios</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
