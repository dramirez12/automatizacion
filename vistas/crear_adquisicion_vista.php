                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="../vistas/gestion_adquisicion_vista">Gestion Adquisiciones</a></li>
                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <!-- SELECT QUE TRAE LOS PRODUCTOS -->
                                        ...
                                        <div class="form-group ">
                                        <label>Ingrese la Descripción de la Adquisición </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" readonly min="<?php date_default_timezone_set('America/Tegucigalpa'); echo date("Y-m-d"); ?>" max="<?php date_default_timezone_set('America/Tegucigalpa'); echo date("Y-m-d"); ?>" value="<?php date_default_timezone_set('America/Tegucigalpa'); echo date("Y-m-d"); ?>" onchange="handler(event);" name="txt_fechaAdquisicion" maxlength="30" style="text-transform: uppercase" onblur="document.getElementById('txt_nombre_oculto').value=this.value" required>
