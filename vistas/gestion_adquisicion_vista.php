            ...
            <?php while ($row = $resultadotabla->fetch_array(MYSQLI_ASSOC)) { ?>
              <tr>
                ...
                <td style="text-align: center;">
                  ...
                  <a href="<?php echo  $_SESSION['btn_editar_bloqueado']; echo $row['id_adquisicion']; ?> " ><button class="btn btn-primary btn-raised btn-xs" <?php echo $_SESSION['botones_adquisicion']; ?>>
