      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h1 align="right"><button class="btn btn-success" name="btnagregar" id="btnagregar" <?php echo $_SESSION['btnagregar']; ?> onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar Nuevo Informe</button></h1>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <p><textarea class="form-control" name="introduccion" id="introduccion" rows="8" required="" maxlength="1000" value="" onkeyup="Card(event, this)"> </textarea></p>
                      </div>
                    </div>
                    <!-- OBJETIVOS -->
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <p><textarea class="form-control" name="objetivos" id="objetivos" rows="8" required="" maxlength="1000" value="" onkeyup="Card(event, this)"> </textarea></p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <p> Solo se admite un documento en formato PDF. Se recomienda insertar las imágenes en de Word o PowerPoint y guardarlo como PDF para importar el archivo.
                        <p>
