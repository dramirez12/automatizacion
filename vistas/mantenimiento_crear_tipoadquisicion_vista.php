                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="../vistas/mantenimiento_tipoadquisicion_vista"> Mantenimiento Tipo Adquisición</a></li>
                        </ol>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p class="text-center" style="margin-top: 20px;">
                                        ...
                                        <a href="../vistas/mantenimiento_tipoadquisicion_vista" class="btn btn-danger"><i class="zmdi zmdi-floppy"></i> Cancelar</a>
