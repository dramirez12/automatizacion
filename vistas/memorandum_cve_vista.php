                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="no_memo" id="no_memo" style="text-transform: uppercase;" placeholder="N° MEMORANDUM" minlength="3" maxlength="50" onkeypress="return soloLetras(event)" oncopy="return false" onpaste="return false" " pattern=" ^[a-zA-Z]{2}-[0-9]{4}$" title="Introduce las letras NM o MN seguido de un guion - y por ultimo un numero de 4 digitos " required="" />
                        </div>
                      </div>
                      <!-- ULTIMO  MEMORANDUM -->
                      <div class="col-sm-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="remitente" id="remitente" style="text-transform: uppercase;" placeholder="REMITENTE" minlength="3" maxlength="50" onkeypress="return soloLetras(event)" oncopy="return false" onpaste="return false" required="" />
                        </div>
                      </div>
                      <!-- DESTINATARIO -->
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="destinatario" id="destinatario" style="text-transform: uppercase;" placeholder="DESTINATARIO" minlength="3" maxlength="50" onkeypress="return soloLetras(event)" oncopy="return false" onpaste="return false" required="" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label>ASUNTO </label>
                          <input type="text" class="form-control" name="asunto" id="asunto" style="text-transform: uppercase;" placeholder="ASUNTO" oncopy="return false" onpaste="return false" required="" />
                        </div>
                      </div>
                      <!-- CONTENIDO -->
                      <div class="col-sm-8">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="contenido" id="contenido" rows="8" style="text-transform: uppercase;" placeholder="DESCRIPCION / CONTENIDO" minlength="3" onkeypress="return soloLetras(event)" oncopy="return false" onpaste="return false" required=""></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
