                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="no_solicitud" id="no_solicitud" maxlength="50" style="text-transform: uppercase " placeholder="No de Solicitud" onkeypress="return soloLetras(event)" oncopy="return false" onpaste="return false" pattern="^[a-zA-Z]{2}-[0-9]{4}$" title="Introduce las letras N o N° seguido de un guion - y por ultimo un numero de 4 digitos " required="" />
                            </div>
                          </div>
