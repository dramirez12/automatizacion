                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <input type="date" max="<?php $hoy = date("Y-m-d");
                                                echo $hoy; ?>" class="form-control" name="fch_inicial_actividad" id="fch_inicial_actividad" maxlength="256">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <input type="date" max="<?php $hoy = date("Y-m-d");
                                                echo $hoy; ?>" class="form-control" name="fch_final_actividad" id="fch_final_actividad" maxlength="256">
                      </div>
