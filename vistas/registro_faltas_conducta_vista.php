            ...
            <div class="box">
              <div class="box-header with-border">
                <h1 align="right"><button class="btn btn-success" name="btnagregar" id="btnagregar" <?php echo $_SESSION['btnagregar']; ?> onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar Nuevo Falta</button>
                  <button class="btn btn-primary" name="btnconstancia" id="btnconstancia" onclick="mostrarform2(true)"><i class="fa fa-plus-circle"></i> Generar Constancia Alumno</button>
                </h1>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                          ...
                          <input type="date" max="<?php $hoy = date("Y-m-d");
                                                  echo $hoy; ?>" class="form-control" name="fch_falta" id="fch_falta" maxlength="256">
                        </div>
                      </div>
                    </div>
                  </div>
