                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label>NOMBRE</label>
                            <input type="text" class="form-control" name="nombre_tipo_memorandum" id="nombre_tipo_memorandum" style="text-transform: uppercase;" placeholder="NOMBRE-MEMORANDUM" minlength="3" maxlength="50" onkeypress="return soloLetras(event)" required="" />
                          </div>
                        </div>
                        <!-- DESCRIPCION -->
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="descripcion_memorandum" id="descripcion_memorandum" style="text-transform: uppercase;" placeholder="DESCRIPCION-MEMORANDUM" minlength="10" maxlength="255" onkeypress="return soloLetras(event)" required="" />
                          </div>
                        </div>
                      </div>
                    </div>
