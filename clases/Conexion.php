...
$base= "informat_informaticaunah2_automatizacion";
...
$connect = new PDO("mysql:host=51.222.86.251;dbname=informat_informaticaunah2_automatizacion", "informat_informaticaunah2", "WAc$W]74{Qo-");
